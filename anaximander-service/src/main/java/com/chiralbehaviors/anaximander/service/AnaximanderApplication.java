 ...
 */
package com.chiralbehaviors.anaximander.service;
...
/**
 * Application server for REST API for Anaximander
 * 
 * @author hhildebrand
 * 
 */
public class AnaximanderApplication
        extends Application<AnaximanderApplicationConfiguration> {

    public static void main(String[] argv) throws Exception {
        new AnaximanderApplication().run(argv);
    }
     ...
     */
    @Override
    public void run(AnaximanderApplicationConfiguration configuration,
    ...
    @Override
    public void initialize(Bootstrap<AnaximanderApplicationConfiguration> bootstrap) {
        bootstrap.addBundle(new AssetsBundle("/angular", "/angular", null,
                                             "phantasm"));
        bootstrap.addBundle(new AssetsBundle("/ui", "/ui", null, "anaximander"));
