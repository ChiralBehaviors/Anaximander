...
var anaximanderUri = "uri:http://ultrastructure.me/ontology/com.chiralbehaviors/demo/anaximander-workspace/v1";
...
myApp
	...
	[
		...
		function ($scope, Restangular) {
			var Anaximander = Restangular.one('/graphql').one('workspace').all(encodeURIComponent(anaximanderUri));
			...
			$scope.loadSteps = function () {
				...
				Anaximander.post(request).then(function (data) {
